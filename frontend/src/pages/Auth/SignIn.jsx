...
import { LogInIcon, Mail, Lock, ArrowRight } from "lucide-react";
              ...
              <div className="grid gap-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      to="/forgot-password"
                      className="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors underline-offset-4 hover:underline"
                    >
                      Forgot password?
                    </Link>
                  </div>
                ...
                >
                  <LogInIcon className="w-5 h-5 mr-2 group-hover:animate-bounce" />
                  Sign In
